...
// ============================================
// STORAGE & GRADIENT MANAGEMENT FUNCTIONS
// ============================================
...
// ============================================
// IMAGE GENERATION & DOWNLOAD FUNCTIONS
// ============================================
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Make colorInputs accessible globally for other functions
  window.colorInputs = colorInputs;
  window.direction = direction;
  window.preview = preview;
  window.gradientCode = gradientCode;
  window.extraColorsDiv = extraColorsDiv;
  window.titles = titles;
  window.gradientContent = gradientContent;
  window.gc = gc;
  ...
  // Resolution container click-outside handler
  ...
  // Resolution selector click-outside handler
  document.addEventListener("click", function (event) {
    const selector = document.getElementById("resolutionBox");
